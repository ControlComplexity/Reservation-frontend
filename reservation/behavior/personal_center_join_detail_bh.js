...
module.exports = Behavior({
	...
	methods: {
		...
		_loadDetail: async function (e) {
			...
			try {
				let join = await cloudHelper.callCloudData('my/personal_center_join_detail', params, opts);
				if (!join) {
					this.setData({
						isLoad: null
					})
		...
		bindCancelTap: async function (e) {
			let callback = async () => {
				try {
					...
					await cloudHelper.callCloudSumbit('my/personal_center_join_cancel', params, opts).then(res => {
